...
Theorem open_in_subset : forall X T U:set,
  open_in X T U -> U c= X.
let X T U. assume Hopen.
claim HT : topology_on X T.
{ exact (andEL (topology_on X T) (U :e T) Hopen). }
claim HU : U :e T.
{ exact (andER (topology_on X T) (U :e T) Hopen). }
...
admit. (**  aby on 2025-11-25 generated_topology_from_subbasis�f conj_myprob_8232_1_20251125_204225 subbasis_on�f finite_intersections_basis_of_subbasis lemma_topology_from_basis prop_ext_2 . **)
Qed.
...
admit. (**  aby on 2025-11-25 ex13_4b_smallest_largest conj_myprob_8373_1_20251125_204258 . **)
Qed.
...
admit. (**  aby on 2025-11-25 generated_topology�f order_topology�f conj_myprob_8496_1_20251125_204259 . **)
Qed.
